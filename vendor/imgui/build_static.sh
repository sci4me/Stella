...
CXXFLAGS="-std=c++17 -g -nostdlib -fno-builtin -fno-rtti -fno-exceptions -fno-unwind-tables -fno-asynchronous-unwind-tables -fno-stack-protector -Wa,--noexecstack -DIMGUI_IMPL_OPENGL_LOADER_GLEW -DGLEW_NO_GLU"
LDFLAGS=""

INCLUDES="-I ${VENDOR_DIR}/GLEW/include"
